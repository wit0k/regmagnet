# The code is taken from: https://github.com/DidierStevens/DidierStevensSuite/blob/master/decode-vbe.py

import re

# Following code is taken from: https://github.com/DidierStevens/DidierStevensSuite/blob/master/decode-vbe.py
def Decode(data):
...
def _decode_vbe(data):

    oMatch = re.search(r'#@~\^......==(.+)......==\^#~@', data)
